...
export class Login {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: Http, public toastCtrl: ToastController, public storage: Storage, public alertCtrl: AlertController, public events: Events, public rest:RestProvider) {
  ...
  login(){
    ...
    userData.user = {
     ...
     this.rest.login(userData.user).subscribe( (res) => {
